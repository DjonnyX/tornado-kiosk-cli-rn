...
interface IConfirmationOrderListItemProps {
    imageHeight: number;
...
export const ConfirmationOrderListItem = React.memo(({ imageHeight, currency, language, position, onChange, onRemove }: IConfirmationOrderListItemProps) => {
